...
MouseAdapter() {
        ...
        lyricsArea.addFocusListener(new AbstractAction("nop") {
		 ...
		 * p.dispatchEvent(e); } public void mouseDragged(MouseEvent e) { } });
		 */
        lyricsArea.addMouseListener(new KeyListener() {
        ...
        lyricsArea.getActionMap().put("nop", new TextAction(
        ...
        lyricsArea.addKeyListener(new TextAction(
        ...
        am.put(DefaultEditorKit.selectLineAction, new ChangeListener() {
            public void stateChanged(ChangeEvent e) {
                lineNumbers.repaint();
            }
        });
        am.put(DefaultEditorKit.insertBreakAction, new );
        ...
        lyricsScrollPane.getViewport().addChangeListener(new );
            ...
            public synchronized void run() {
                try {
                    ...
                    for (Enumeration<Integer> en = errLines.elements(); en
                            .hasMoreElements(); ) {
                        int si = ((Integer) en.nextElement()).intValue();
                        int ei = ((Integer) en.nextElement()).intValue();
                        lyricsArea.getStyledDocument().setCharacterAttributes(
